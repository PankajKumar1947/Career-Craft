...
const FacultyCard = ({facultyList}) => {
  return (
    <>
      <div className=' flex flex-col gap-1 justify-center items-center py-4 bg-gradient-to-br from-gray-100 via-gray-400 to-gray-950   rounded-3xl '>
          ...
          <div className='flex justify-center items-center gap-4 lg:mt-4'>
            <img src={workExp} alt="" />
            <div>
          ...
          <p className='px-2 md:px-5 lg:px-10 text-center text-gray-200 text-xl lg:mt-4'>{facultyList.desc}</p>
        </div>
    </>
  )
}
