...
const Courses = ({eachCourse}) => {
  ...
  return (
    ...
    <div className='w-full mt-8 p-2 lg:pt-3 lg:px-4 pb-3 rounded-xl bg-gray-800'>
        ...
        <h1 className='text-xl md:text-2xl lg:text-2xl text-center mt-3'>{eachCourse.title}</h1>
        <div className='flex justify-center gap-2 md:gap-4 lg:gap-5 items-center mt-2'>
            <div>
                <p className='text-md font-semibold'>₹ {eachCourse.currentPrice} <span className='text-sm line-through font-extralight'>₹ {eachCourse.originalPrice}</span></p>
            </div>
